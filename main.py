...
def parse_args():
    ...
    parser.add_argument("--deep_cluster_and_contrastive_loss",
                        action="store_true"
                        )
